...
(function (global, factory) {
    ...
    class OklabColorManager {
        ...
        handleRangeColor(color) {
            ...
            return oklabToRgb({
                l: engine.getRangeValue(oklabColor.l),
                aAxis: engine.getRangeValue(oklabColor.aAxis),
                bAxis: engine.getRangeValue(oklabColor.bAxis),
            });
        }
        parseString(input) {
    ...
    exports.loadOklabColorPlugin = loadOklabColorPlugin;

}));
Object.assign(globalThis.window || globalThis, { loadOklabColorPlugin: (globalThis.__tsParticlesInternals.plugins.oklabColor || {}).loadOklabColorPlugin });
