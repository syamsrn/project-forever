...
(function (global, factory) {
    ...
    class OklchColorManager {
        ...
        handleRangeColor(color) {
            ...
            return oklchToRgb({
                l: engine.getRangeValue(oklchColor.l),
                c: engine.getRangeValue(oklchColor.c),
                h: engine.getRangeValue(oklchColor.h),
            });
        }
        parseString(input) {
...
Object.assign(globalThis.window || globalThis, { loadOklchColorPlugin: (globalThis.__tsParticlesInternals.plugins.oklchColor || {}).loadOklchColorPlugin });
