...
(function (global, factory) {
    ...
    class BrownianPathGenerator {
        ...
        generate(p) {
            ...
            const b = p.brownian, delta = (engine.getRandom() * 2 - 1) * (this.options.angleDelta ?? 0);
            b.angle += delta;
            const damping = this.options.damping ?? engine.identity;
            p.velocity.x = 0;
            p.velocity.y = 0;
    ...
    exports.brownianPathName = brownianPathName;
    exports.loadBrownianPath = loadBrownianPath;

}));
Object.assign(globalThis.window || globalThis, { loadBrownianPath: (globalThis.__tsParticlesInternals.paths.brownian || {}).loadBrownianPath });
