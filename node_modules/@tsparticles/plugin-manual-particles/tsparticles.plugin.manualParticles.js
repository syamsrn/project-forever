        ...
        load(data) {
            ...
            if (data.position) {
                this.position = {
                    ...
                    mode: data.position.mode ?? engine.PixelMode.percent,
                };
            }
            if (data.options) {
...
Object.assign(globalThis.window || globalThis, { loadManualParticlesPlugin: (globalThis.__tsParticlesInternals.plugins.manualParticles || {}).loadManualParticlesPlugin });
