...
(function (global, factory) {
    ...
    class InteractivityParticleMaker extends pluginInteractivity.ExternalInteractorBase {
        ...
        interact(interactivityData) {
                    ...
                    if (interactivityParticleOptions.replaceCursor) {
                        ...
                        if (element) {
                            if (element instanceof Window || element instanceof Document) {
                                engine.safeDocument().body.style.cursor = "";
                            }
                            else {
            ...
            if (!this.#particle) {
                ...
                if (interactivityParticleOptions.replaceCursor) {
                    ...
                    if (element) {
                        if (element instanceof Window || element instanceof Document) {
                            engine.safeDocument().body.style.cursor = "none";
                        }
                        else {
        ...
        isEnabled(interactivityData, particle) {
            ...
            return (!!events &&
                ((mouse.clicking && mouse.inside && !!mouse.position && engine.isInArray(particleMode, events.onClick.mode)) ||
...
Object.assign(globalThis.window || globalThis, { loadExternalParticleInteraction: (globalThis.__tsParticlesInternals.interactions.externalParticle || {}).loadExternalParticleInteraction });
