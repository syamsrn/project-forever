...
(function (global, factory) {
    ...
    class TrailPluginInstance {
        layer = engine.DrawLayer.PluginContent;
        #container;
        #pluginManager;
        #trailFill;
        ...
        canvasClear() {
            ...
            if (trailFill.color) {
                canvas.render.paintBase(engine.getStyleFromRgb(trailFill.color, container.hdr, trailFill.opacity));
                handled = true;
            }
        ...
        async #initTrail() {
            ...
            const trailFill = trail.fill, opacity = engine.inverseFactorNumerator / trail.length;
            if (trailFill.color) {
                const fillColor = engine.rangeColorToRgb(this.#pluginManager, trailFill.color);
                if (!fillColor) {
                    return;
                }
                this.#trailFill = {
...
Object.assign(globalThis.window || globalThis, { loadTrailPlugin: (globalThis.__tsParticlesInternals.plugins.trail || {}).loadTrailPlugin });
