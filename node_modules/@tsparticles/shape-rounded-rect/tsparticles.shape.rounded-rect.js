...
(function (global, factory) {
    ...
    class RoundedRectDrawer {
        draw(data) {
            const { context, particle, radius } = data, fixedRadius = radius * Math.SQRT1_2, fixedDiameter = fixedRadius * engine.double, borderRadius = particle.borderRadius ?? defaultRadius;
        ...
        particleInit(container, particle) {
            ...
            particle.borderRadius = engine.getRangeValue(shapeData?.radius ?? defaultRadius) * container.retina.pixelRatio;
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadRoundedRectShape: (globalThis.__tsParticlesInternals.shapes.roundedRect || {}).loadRoundedRectShape });
