...
(function (global, factory) {
    ...
    class LchColorManager {
        ...
        handleRangeColor(color) {
            ...
            return lchToRgb({
                l: engine.getRangeValue(lchColor.l),
                c: engine.getRangeValue(lchColor.c),
                h: engine.getRangeValue(lchColor.h),
            });
        }
        parseString(input) {
    ...
    exports.loadLchColorPlugin = loadLchColorPlugin;

}));
Object.assign(globalThis.window || globalThis, { loadLchColorPlugin: (globalThis.__tsParticlesInternals.plugins.lchColor || {}).loadLchColorPlugin });
