    ...
    class ExportVideoPluginInstance {
        ...
        async #exportVideo(data) {
            ...
            return new Promise(resolve => {
                ...
                setTimeout(() => {
                    recorder.stop();
                }, data.duration ?? defaultDuration * engine.millisecondsToSeconds);
            });
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadExportVideoPlugin: (globalThis.__tsParticlesInternals.plugins.video || {}).loadExportVideoPlugin });
