...
(function (global, factory) {
    ...
    const angularFrequencyFactor = 0.5, halfPI = Math.PI * engine.half;
    ...
    class ZigZagPathGenerator {
        ...
        generate(particle, delta) {
            ...
            particle.zigzag ??= {
                ...
                waveLength: engine.getRangeValue(options.waveLength),
            };
    ...
    exports.zigZagPathName = zigZagPathName;

}));
Object.assign(globalThis.window || globalThis, { loadZigZagPath: (globalThis.__tsParticlesInternals.paths.zigzag || {}).loadZigZagPath });
