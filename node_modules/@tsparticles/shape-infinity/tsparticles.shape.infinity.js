...
(function (global, factory) {
    ...
    function drawInfinity(data) {
        ...
        context.moveTo(engine.originPoint.x, engine.originPoint.y);
        context.bezierCurveTo(loopControl, -radius, loopControl, radius, engine.originPoint.x, engine.originPoint.y);
        context.moveTo(engine.originPoint.x, engine.originPoint.y);
        context.bezierCurveTo(-loopControl, -radius, engine.originPoint.x - loopControl, radius, engine.originPoint.x, engine.originPoint.y);
    }
...
Object.assign(globalThis.window || globalThis, { loadInfinityShape: (globalThis.__tsParticlesInternals.shapes.infinity || {}).loadInfinityShape });
