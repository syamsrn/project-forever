...
(function (global, factory) {
    ...
    class HwbColorManager {
        ...
        handleRangeColor(color) {
            ...
            return hwbToRgb({
                h: engine.getRangeValue(hwbColor.h),
                w: engine.getRangeValue(hwbColor.w),
                b: engine.getRangeValue(hwbColor.b),
            });
        }
        parseString(input) {
            ...
            return hwbaToRgba({
                a: result.length > minLength ? engine.parseAlpha(result[HwbIndexes.a]) : defaultAlpha,
    ...
    exports.loadHwbColorPlugin = loadHwbColorPlugin;

}));
Object.assign(globalThis.window || globalThis, { loadHwbColorPlugin: (globalThis.__tsParticlesInternals.plugins.hwbColor || {}).loadHwbColorPlugin });
