...
(function (global, factory) {
    ...
    class RandomPathGenerator {
        ...
        generate() {
            this.#res.x = engine.getRandomInRange(minRandom, maxRandom);
            this.#res.y = engine.getRandomInRange(minRandom, maxRandom);
            return this.#res;
        }
        init() {
        }
    ...
    exports.loadRandomPath = loadRandomPath;
    exports.randomPathName = randomPathName;

}));
Object.assign(globalThis.window || globalThis, { loadRandomPath: (globalThis.__tsParticlesInternals.paths.random || {}).loadRandomPath });
