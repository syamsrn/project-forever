...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__tsParticlesInternals = global.__tsParticlesInternals || {}, global.__tsParticlesInternals.path = global.__tsParticlesInternals.path || {}, global.__tsParticlesInternals.path.utils = global.__tsParticlesInternals.path.utils || {})));
    ...
    function drawPath(ctx, radius, path) {
        ...
        for (const segment of path.segments) {
            ...
            switch (segment.type) {
                case exports.SegmentType.move:
                    ctx.moveTo(value.x * radius, value.y * radius);
                    break;
                case exports.SegmentType.line:
                    ctx.lineTo(value.x * radius, value.y * radius);
                    break;
                case exports.SegmentType.bezier:
                    ...
                    break;
                case exports.SegmentType.quadratic:
