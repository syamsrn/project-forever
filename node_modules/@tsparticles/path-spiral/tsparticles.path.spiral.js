...
(function (global, factory) {
    ...
    class SpiralPathGenerator {
        ...
        generate(particle, delta) {
            ...
            particle.spiral ??= {
                ...
                maxRadius: engine.getRangeValue(options.maxRadius),
                angularSpeed: engine.getRangeValue(options.angularSpeed) * speedFactor,
                radialSpeed: engine.getRangeValue(options.radialSpeed) * speedFactor,
            };
    ...
    exports.spiralPathName = spiralPathName;

}));
Object.assign(globalThis.window || globalThis, { loadSpiralPath: (globalThis.__tsParticlesInternals.paths.spiral || {}).loadSpiralPath });
