...
(function (global, factory) {
    ...
    function drawHeart(data) {
        const { context, radius } = data, diameter = radius * engine.double, halfRadius = radius * engine.half, radiusAndHalf = radius + halfRadius, x = -radius, y = -radius;
...
Object.assign(globalThis.window || globalThis, { loadHeartShape: (globalThis.__tsParticlesInternals.shapes.heart || {}).loadHeartShape });
