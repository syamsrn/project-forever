...
(function (global, factory) {
    ...
    const popMode = "pop";
    class Popper extends pluginInteractivity.ExternalInteractorBase {
        handleClickMode;
        maxDistance = 0;
        ...
        isEnabled(interactivityData, particle) {
            ...
            return !!events && mouse.clicking && mouse.inside && !!mouse.position && engine.isInArray(popMode, events.onClick.mode);
        }
        reset() {
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadExternalPopInteraction: (globalThis.__tsParticlesInternals.interactions.externalPop || {}).loadExternalPopInteraction });
