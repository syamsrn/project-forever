...
(function (global, factory) {
    ...
    class ShadowDrawer {
        ...
        drawBefore(data) {
            ...
            context.shadowColor = engine.getStyleFromRgb(shadowColor, container.hdr);
        ...
        particleInit(_container, particle) {
            const effectData = particle.effectData, shadowColor = engine.OptionsColor.create(new engine.OptionsColor(), effectData?.color);
            particle.shadowColor = engine.rangeColorToRgb(this.#pluginManager, shadowColor);
            particle.shadowBlur = effectData?.blur ?? defaultShadowBlur;
            particle.shadowOffset = effectData?.offset ?? engine.originPoint;
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadShadowEffect: (globalThis.__tsParticlesInternals.effects.shadow || {}).loadShadowEffect });
