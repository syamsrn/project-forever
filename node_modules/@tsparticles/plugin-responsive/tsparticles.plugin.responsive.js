...
(function (global, factory) {
    ...
    class Responsive {
        ...
        load(data) {
            ...
            if (!engine.isNull(data.maxWidth)) {
                this.maxWidth = data.maxWidth;
            }
            if (!engine.isNull(data.mode)) {
    ...
    exports.loadResponsivePlugin = loadResponsivePlugin;

}));
Object.assign(globalThis.window || globalThis, { loadResponsivePlugin: (globalThis.__tsParticlesInternals.plugins.responsive || {}).loadResponsivePlugin });
