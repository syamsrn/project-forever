...
(function (global, factory) {
    ...
    class SpiralDrawer {
        ...
        particleInit(container, particle) {
            ...
            particle.spiralInnerRadius = engine.getRangeValue(shapeData?.innerRadius ?? defaultInnerRadius) * pixelRatio;
            particle.spiralLineSpacing = engine.getRangeValue(shapeData?.lineSpacing ?? defaultLineSpacing) * pixelRatio;
            particle.spiralWidthFactor = engine.getRangeValue(shapeData?.widthFactor ?? defaultWidthFactor);
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadSpiralShape: (globalThis.__tsParticlesInternals.shapes.spiral || {}).loadSpiralShape });
