...
(function (global, factory) {
    ...
    class BranchesPathGenerator {
        ...
        generate(p) {
            ...
            const b = p.branching;
            if (b.remaining <= 0) {
                const branch = engine.getRandom() < (opts.branchChance ?? 0), maxAngle = opts.maxAngle ?? defaultOptions.maxAngle, delta = (engine.getRandom() * 2 - 1) * (branch ? maxAngle : maxAngle * 0.3);
                b.angle += delta;
                b.remaining = opts.segmentLength;
                const speedFactor = 1 + (engine.getRandom() * 2 - 1) * (opts.speedVariation ?? 0);
    ...
    exports.branchingPathName = branchingPathName;
    exports.loadBranchesPath = loadBranchesPath;

}));
Object.assign(globalThis.window || globalThis, { loadBranchesPath: (globalThis.__tsParticlesInternals.paths.branches || {}).loadBranchesPath });
