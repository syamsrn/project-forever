...
(function (global, factory) {
    ...
    class Motion {
        ...
        load(data) {
            ...
            engine.loadProperty(this, "disable", data.disable);
    ...
    class MotionPluginInstance {
        ...
        async init() {
            ...
            const mediaQuery = engine.safeMatchMedia("(prefers-reduced-motion: reduce)");
            if (!mediaQuery) {
...
Object.assign(globalThis.window || globalThis, { loadMotionPlugin: (globalThis.__tsParticlesInternals.plugins.motion || {}).loadMotionPlugin });
